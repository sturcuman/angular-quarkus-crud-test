            ...
            <div class="modal-content rounded-4 shadow">
                ...
                <div class="modal-body p-5 pt-0">
                    <form>
                        ...
                        <div class="form-floating mb-3">
                            <input required type="text" class="form-control rounded-3" id="color" [(ngModel)]="color"
                                   name="color">
...
export class UpdateCarModalComponent {
    ...
    async onSubmit() {
        ...
        await this.carService.updateById(this.id, this.type, this.model, this.color, this.price);

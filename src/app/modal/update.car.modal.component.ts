    ...
    <div class="modal modal-sheet position-static d-block bg-body-secondary" tabindex="-1" role="dialog" id="modalSignin">
        <div class="modal-content rounded-4 shadow">
            ...
            <div class="modal-header p-5 pb-4 border-bottom-0">
                <h1 class="fw-bold mb-0 fs-2">Update car</h1>
            ...
            <div class="modal-body p-5 pt-0">
                <form> 
                    ...
                    <button (click)="onSubmit()" class="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="submit">Update</button>
                </form>
            </div>
        </div>
    </div>`,
...
export class UpdateCarModalComponent {
    ...
    async onSubmit() {
        ...
        await this.carService.updateById(this.id, this.brand, this.model, this.country, this.price);
